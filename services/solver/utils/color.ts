...
// @ts-ignore Linter incorrectly thinks reduce function can return undefined
...
const LightnessThreshold = 350 // Also taken as distance from pure black for simplicity
